...
const replacements = [
  ...
  { from: /luxury-button-gold/g, to: 'app-button-primary' },
  { from: /luxury-button-outline/g, to: 'app-button-outline' },
  { from: /luxury-card/g, to: 'app-card' },
  { from: /luxury-ripple/g, to: 'app-ripple' }
];
